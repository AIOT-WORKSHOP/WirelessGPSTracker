...
GM_ERRCODE gsm_get_model_imei(U8* p_imei)
{
...
GM_ERRCODE gsm_get_imei(U8 *p_imei)
{
    ...
    config_service_get(CFG_DEVICE_NUMBER,TYPE_STRING,dev_num,17);

    if(11 == GM_strlen((char *)dev_num))
    {
        GM_sprintf((char *)p_imei,"6686%s",dev_num);
